  ...
  <div class="dashboard-container">
    ...
    <div class="situation-content">
      ...
      <div class="content-right">
        ...
        <div class="exam-info">
          <div>
            <span class="content-title">未录入成绩分布：</span>
          </div>
          <div>
            <barChart
              ref="exam-bar-echart"
...
export default {
  ...
  methods: {
    getData() {
      ...
      api
        .getSelectUnEnteredByTeacherName(this.userInfo.username)
        .then((res) => {
          console.log("[ res ]-114", res);
          this.optionRevenueBar = {
            // title: `未录入成绩分布`,
            // serieData: { datas: [1, 23, 4], xaxis: ["s", "s", "a"] },
            // serieData: res.data,
            serieData: {
    ...
    courseChange() {
      api.getSelectNumByCourseId(this.echartCourseId).then((res) => {
